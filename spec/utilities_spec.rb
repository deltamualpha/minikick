...
RSpec.describe Utilities do
  describe 'Utilities' do
    ...
    it 'rejects invalid names' do
      expect{ Utilities.validate_name 'foo_bar-123' }.to_not raise_error
    ...
    it 'rejects negative monetary values' do
    ...
    it 'rejects non-numeric inputs' do
      ...
      expect{ Utilities.validate_money '💩' }.to raise_error
    end

    it 'rejects zero-value pledges' do
